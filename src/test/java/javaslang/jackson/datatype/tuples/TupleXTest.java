...
public class TupleXTest extends BaseTest {
    ...
    public void test0() throws IOException {
        ...
        Assert.assertEquals(mapper().readValue(extended, Tuple.class), tuple0);
        Assert.assertEquals(mapper().readValue(compact, Tuple.class), tuple0);
    }
    ...
    public void test10() throws IOException {
        ...
        mapper().readValue(wrongClass, Tuple.class);
    }
}
