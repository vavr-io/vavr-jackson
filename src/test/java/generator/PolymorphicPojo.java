...
public class PolymorphicPojo {
    ...
    static void generate() throws IOException {
        ...
        addCase(pojoTest, lazy, HashMap.of("type", "a"),
            ...
            m -> m.addStatement("$T.assertThat(restored.get()).isInstanceOf(A.class)", ClassName.get(Assertions.class)));
        ...
        addCase(pojoTest, "Left", true, either, List.of("left", HashMap.of("type", "a")),
            ...
            m -> m.addStatement("$T.assertThat(restored.isLeft()).isTrue()", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.getLeft()).isInstanceOf(A.class)", ClassName.get(Assertions.class)));
        addCase(pojoTest, "Right", false, either, List.of("right", HashMap.of("type", "a")),
            ...
            m -> m.addStatement("$T.assertThat(restored.isRight()).isTrue()", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.get()).isInstanceOf(A.class)", ClassName.get(Assertions.class)));
        ...
        addCase(builder, ptn, args,
            ...
            m -> {
                for (int i = 0; i < arity; i++) {
                    m.addStatement("$T.assertThat(restored._$L).isInstanceOf($L.class)", ClassName.get(Assertions.class), i + 1, (i % 2) == 0 ? "A" : "B");
                }
            });
    }
    ...
    private static void addSeqCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, List.of(HashMap.of("type", "a"), HashMap.of("type", "b")),
            ...
            m -> m
                .addStatement("$T.assertThat(restored.get(0)).isInstanceOf(A.class)", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.get(1)).isInstanceOf(B.class)", ClassName.get(Assertions.class)));
    }
    ...
    private static void addMapCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, HashMap.of("a", HashMap.of("type", "a"), "b", HashMap.of("type", "b")),
            ...
            m -> m
                .addStatement("$T.assertThat(restored.get($S).get()).isInstanceOf(A.class)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(restored.get($S).get()).isInstanceOf(B.class)", ClassName.get(Assertions.class), "b"));
    }
    ...
    private static void addMultimapCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, HashMap.of("a", List.of(HashMap.of("type", "a")), "b", List.of(HashMap.of("type", "b"))),
            ...
            m -> m
                .addStatement("$T.assertThat(restored.get($S).get().head()).isInstanceOf(A.class)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(restored.get($S).get().head()).isInstanceOf(B.class)", ClassName.get(Assertions.class), "b"));
    }
