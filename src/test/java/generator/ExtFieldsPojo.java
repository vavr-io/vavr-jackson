...
public class ExtFieldsPojo {
    ...
    static void generate() throws IOException {
        ...
        addCase(pojoTest, lazy, HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b")),
            ...
            m -> m.addStatement("$T.assertThat(restored.get()).isInstanceOf(B.class)", ClassName.get(Assertions.class))

                .addStatement("$T.assertThat(restored.get().a).isEqualTo($S)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(((B) restored.get()).b).isEqualTo($S)", ClassName.get(Assertions.class), "b"));
        ...
        addCase(pojoTest, "Left", true, either, List.of("left", HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b"))),
            ...
            m -> m.addStatement("$T.assertThat(restored.isLeft()).isTrue()", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.getLeft()).isInstanceOf(B.class)", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.getLeft().a).isEqualTo($S)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(((B) restored.getLeft()).b).isEqualTo($S)", ClassName.get(Assertions.class), "b"));
        addCase(pojoTest, "Right", false, either, List.of("right", HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b"))),
            ...
            m -> m.addStatement("$T.assertThat(restored.isRight()).isTrue()", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.get()).isInstanceOf(B.class)", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.get().a).isEqualTo($S)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(((B) restored.get()).b).isEqualTo($S)", ClassName.get(Assertions.class), "b"));

        JavaFile.builder("io.vavr.jackson.generated", pojoTest.build())
            .indent("    ")
        ...
        addCase(builder, ptn, args,
            ...
            m -> {
                for (int i = 0; i < arity; i++) {
                    m.addStatement("$T.assertThat(restored._$L).isInstanceOf($L.class)", ClassName.get(Assertions.class), i + 1, "B")
                        .addStatement("$T.assertThat(restored._$L.a).isEqualTo($S)", ClassName.get(Assertions.class), i + 1, "a")
                        .addStatement("$T.assertThat(((B) restored._$L).b).isEqualTo($S)", ClassName.get(Assertions.class), i + 1, "b");
                }
            });
    }
    ...
    private static void addSeqCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, List.of(HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b"))),
            ...
            m -> m.addStatement("$T.assertThat(restored.get(0)).isInstanceOf(B.class)", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.get(0).a).isEqualTo($S)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(((B) restored.get(0)).b).isEqualTo($S)", ClassName.get(Assertions.class), "b"));
    }
    ...
    private static void addSetCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, List.of(HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b"))),
            m -> m.addStatement("$T src = $T.of(new B($S, $S))", ptn, ptn.rawType, "a", "b"),
            m -> m.addStatement("$T.assertThat(restored.filter(e -> e instanceof B).length()).isEqualTo(1)", ClassName.get(Assertions.class))
                .addStatement("$T.assertThat(restored.head().a).isEqualTo($S)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(((B) restored.head()).b).isEqualTo($S)", ClassName.get(Assertions.class), "b"));
    }
    ...
    private static void addMapCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, HashMap.of("a", HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b"))),
            ...
            m -> m.addStatement("$T.assertThat(restored.get($S).get()).isInstanceOf(B.class)", ClassName.get(Assertions.class), "a")

                .addStatement("$T.assertThat(restored.get($S).get().a).isEqualTo($S)", ClassName.get(Assertions.class), "a", "a")
                .addStatement("$T.assertThat(((B) restored.get($S).get()).b).isEqualTo($S)", ClassName.get(Assertions.class), "a", "b"));
    }
    ...
    private static void addMultimapCase(TypeSpec.Builder builder, Class<?> clz) {
        ...
        addCase(builder, ptn, HashMap.of("a", List.of(HashMap.of("ExtFieldsPojoTest$B", HashMap.of("a", "a", "b", "b")))),
            ...
            m -> m.addStatement("$T.assertThat(restored.get($S).get().head()).isInstanceOf(B.class)", ClassName.get(Assertions.class), "a")
                .addStatement("$T.assertThat(restored.get($S).get().head().a).isEqualTo($S)", ClassName.get(Assertions.class), "a", "a")
                .addStatement("$T.assertThat(((B) restored.get($S).get().head()).b).isEqualTo($S)", ClassName.get(Assertions.class), "a", "b"));
    }
    ...
    private static void addCase(TypeSpec.Builder builder, String namePostfix, boolean makePojo, ParameterizedTypeName ptn, Object value, Consumer<MethodSpec.Builder> init, Consumer<MethodSpec.Builder> check) {
        ...
        methodBuilder
            ...
            .addStatement("$T.assertThat(json).isEqualTo($S)", ClassName.get(Assertions.class), json)
