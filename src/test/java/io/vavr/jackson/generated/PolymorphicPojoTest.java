...
public class PolymorphicPojoTest {
    ...
    void shouldHandleArray() {
        ...
        org.junit.jupiter.api.Assertions.assertTrue(restored.get(0) instanceof A);
        org.junit.jupiter.api.Assertions.assertTrue(restored.get(1) instanceof B);
    }
    ...
    void shouldHandleHashMap() {
        ...
        org.junit.jupiter.api.Assertions.assertTrue(restored.get("a").get() instanceof A);
        org.junit.jupiter.api.Assertions.assertTrue(restored.get("b").get() instanceof B);
    }
    ...
    void shouldHandleHashMultimap() {
        ...
        org.junit.jupiter.api.Assertions.assertTrue(restored.get("a").get().head() instanceof A);
        org.junit.jupiter.api.Assertions.assertTrue(restored.get("b").get().head() instanceof B);
    }
    ...
    void shouldHandleTuple1() {
        ...
        Assertions.assertThat(restored._1).isInstanceOf(A);
    }
    ...
    void shouldHandleTuple2() {
        ...
        Assertions.assertThat(restored._1).isInstanceOf(A);
        Assertions.assertThat(restored._2).isInstanceOf(B);
    }
    ...
    void shouldHandleTuple3() {
        ...
        Assertions.assertThat(restored._1).isInstanceOf(A);
        Assertions.assertThat(restored._2).isInstanceOf(B);
        Assertions.assertThat(restored._3).isInstanceOf(A);
    }
    ...
    void shouldHandleTuple4() {
        ...
        Assertions.assertThat(restored._2).isInstanceOf(B);
        Assertions.assertThat(restored._3).isInstanceOf(A);
        Assertions.assertThat(restored._4).isInstanceOf(B);
    }
    ...
    void shouldHandleTuple5() {
        ...
        Assertions.assertThat(restored._3).isInstanceOf(A);
        Assertions.assertThat(restored._4).isInstanceOf(B);
        Assertions.assertThat(restored._5).isInstanceOf(A);
    }
    ...
    void shouldHandleTuple6() {
        ...
        Assertions.assertThat(restored._4).isInstanceOf(B);
        Assertions.assertThat(restored._5).isInstanceOf(A);
        Assertions.assertThat(restored._6).isInstanceOf(B);
    }
    ...
    void shouldHandleTuple7() {
        ...
        Assertions.assertThat(restored._5).isInstanceOf(A);
        Assertions.assertThat(restored._6).isInstanceOf(B);
        Assertions.assertThat(restored._7).isInstanceOf(A);
    }
    ...
    void shouldHandleTuple8() {
        ...
        Assertions.assertThat(restored._6).isInstanceOf(B);
        Assertions.assertThat(restored._7).isInstanceOf(A);
        Assertions.assertThat(restored._8).isInstanceOf(B);
    }
